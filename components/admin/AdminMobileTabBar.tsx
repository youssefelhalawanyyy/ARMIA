            ...
            <div className="space-y-2 pt-1 text-xs">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-semibold">Abandoned Carts Recovery</span>
                </div>
                <span className="text-neutral-500 text-[11px]">→</span>
              </Link>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-semibold">Push Notifications Broadcast</span>
                </div>
                <span className="text-neutral-500 text-[11px]">→</span>
              </Link>
              ...
              >
                <div className="flex items-center gap-3">
                  <Package className="w-4 h-4 text-[#DCC9A6]" />
                  <span className="font-semibold">Clients Database & CRM</span>
                </div>
                <span className="text-neutral-500 text-[11px]">→</span>
              </Link>
