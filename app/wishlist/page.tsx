      ...
      <main className="flex-grow py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {loading ? (
            ...
            <div className="text-center py-16 bg-white border border-[#E8E2D8] p-8 max-w-md mx-auto rounded-xl">
              ...
              <Link
                href="/collections"
                className="inline-flex items-center gap-2 bg-[#1F1F1F] text-[#DCC9A6] px-6 py-3 text-xs uppercase tracking-[0.2em] font-sans font-bold hover:bg-[#B67355] hover:text-white transition-colors rounded"
              >
                <span>{t.wishlist.exploreBtn}</span>
